...
If you are working on a National Park Service computer, there are a few additional requirements and suggestions. You can install most of the required software yourself from the NPS Company Portal but installing JAGS requires a Bison Support System (BSS) ticket.
